...
import inference_comparison.ConverterADF2CL;
...
public class PossibilisticGammaOperator {
	...
	public static void main(String[] args) throws ParserException, IOException {
		...
		// Set path to ADF
		//String path_to_adf = "src/resources/possibilistic_adf_previous_ex6_ex8.txt";
		//String path_to_adf = "src/resources/possibilistic_adf_previous_ex7.txt";
		String path_to_adf = "src/resources/possibilistic_adf_ex8.txt";
